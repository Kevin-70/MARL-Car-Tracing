...
from pogema_ours import GridConfig, ExtraHard64x64, Hard64x64, Normal64x64, Easy64x64, ExtraHard32x32, Hard32x32, \
    Normal32x32, Easy32x32, ExtraHard16x16, Hard16x16, Normal16x16, Easy16x16, ExtraHard8x8, Hard8x8, Normal8x8, Easy8x8, OneCriminal
...
class PymarlSettings(BaseModel):
    ...
    fixed_p: bool = False #fix=0表示贼车固定算法(警车网络),1表示警车固定算法(贼车网络),否则都不固定网络
    epsilon: float = 0.5
...
class Environment(BaseModel):
    grid_config: Union[
        ...
        Easy64x64, Normal64x64, Hard64x64, ExtraHard64x64, OneCriminal, 
