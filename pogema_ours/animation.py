...
from pogema_ours import GridConfig#, pogema_v0
from pogema_ours.grid import Grid
from pogema_ours.wrappers.persistence import PersistentWrapper, AgentState
...
class AnimationMonitor(Wrapper):
    ...
    def step(self, action):
        ...
        if multi_agent_terminated or single_agent_terminated or multi_agent_truncated or single_agent_truncated:
            ...
            if save_tau:
                if (self._episode_idx + 1 ) % save_tau == 0 or save_tau == 1:
